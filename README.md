...
### Objective:
This project analyzed sales data from two companies—Kelvin Cookies and a bike sales company. The goal was to understand sales performance, identify trends, and derive actionable insights for business growth.
